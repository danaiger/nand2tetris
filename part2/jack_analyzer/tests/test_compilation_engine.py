...
def test_let_statement_expressionless_no_array(tmp_path):
    input_path = tmp_path /"input_file"
    output_path = tmp_path /"output_file"
    input_path.write_text("""class SomeClass {
    method void draw() {
...
def test_multiple_let_statement_expressionless_no_array(tmp_path):
    input_path = tmp_path /"input_file"
    output_path = tmp_path /"output_file"
    input_path.write_text("""class SomeClass {
    method void draw() {
...
def test_if_statement_expressionless_no_array_no_else(tmp_path):
    input_path = tmp_path /"input_file"
    output_path = tmp_path /"output_file"
    input_path.write_text("""class SomeClass {
    method void draw() {
...
def test_while_statement_expressionless_no_array(tmp_path):
    input_path = tmp_path /"input_file"
    output_path = tmp_path /"output_file"
    input_path.write_text("""class SomeClass {
    method void draw() {
...
def test_do_statement_for_functions_expressionless_no_array(tmp_path):
    input_path = tmp_path /"input_file"
    output_path = tmp_path /"output_file"
    input_path.write_text("""class SomeClass {
    method void draw() {
...
def test_do_statement_for_methods_expressionless_no_array(tmp_path):
    input_path = tmp_path /"input_file"
    output_path = tmp_path /"output_file"
    input_path.write_text("""class SomeClass {
    method void draw() {
